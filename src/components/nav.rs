                ...
                <div class="container-page flex h-16 items-center justify-between gap-3">
                    ...
                    <nav class="flex items-center gap-4 font-mono text-sm lg:gap-8">
                        ...
                        <div class="hidden items-center gap-2 sm:flex">
                            <SocialLinks label_class="hidden lg:inline"/>
                        </div>
                        <button
                            type="button"
...
#[component]
fn SocialLinks(#[prop(default = "")] label_class: &'static str) -> impl IntoView {
    let label_class = format!("text-xs uppercase tracking-[0.2em] {label_class}");
    view! {
        <a
        ...
        >
            ...
            <span class=label_class.clone()>"discord"</span>
        </a>
        <a
        ...
        >
            ...
            <span class=label_class.clone()>"github"</span>
        </a>
        <a
        ...
        >
            ...
            <span class=label_class>"linkedin"</span>
        </a>
    }
}
