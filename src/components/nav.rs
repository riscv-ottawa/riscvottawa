...
pub fn Nav() -> impl IntoView {
    view! {
        <header class="hairline sticky top-0 z-40 bg-paper/80 backdrop-blur">
            <div class="container-page flex h-16 items-center justify-between">
                ...
                <nav class="flex items-center gap-6 font-mono text-sm md:gap-8">
                    <A href="/trainings" attr:class="text-mute transition-colors hover:text-ink">
                        "trainings"
                    </A>
                    <A href="/events" attr:class="text-mute transition-colors hover:text-ink">
                        "events"
                    </A>
                    <ThemeToggle/>
                    <a
